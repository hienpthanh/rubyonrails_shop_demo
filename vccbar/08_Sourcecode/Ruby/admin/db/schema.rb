...
ActiveRecord::Schema.define(version: 1) do
  ...
  create_table "d_product", primary_key: "product_id", force: :cascade do |t|
    ...
    t.string   "product_image",       limit: 255,                                  null: false
    t.decimal  "price",                             precision: 10, default: 0,     null: false
    t.decimal  "price_special",                     precision: 10, default: 0,     null: false
    t.integer  "in_stock",            limit: 4,                    default: 0,     null: false
    t.boolean  "is_active",                                        default: true,  null: false
    t.boolean  "is_hot",                                           default: false, null: false
    t.boolean  "is_slider",                                        default: false, null: false
  ...
  create_table "d_unit", primary_key: "unit_id", force: :cascade do |t|
  ...
  create_table "d_user", primary_key: "user_id", force: :cascade do |t|
    t.string   "username",      limit: 255, null: false
    t.string   "password",      limit: 50,  null: false
    ...
    t.boolean  "modified_by"
  end

  create_table "d_warehouse_import", primary_key: "import_id", force: :cascade do |t|
  ...
  create_table "d_warehouse_import_item", primary_key: "import_item_id", force: :cascade do |t|
